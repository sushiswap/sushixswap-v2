...
interface ISushiXSwapV2 {
    ...
    event SushiXSwapOnSrc(
        bytes2 indexed refId, address indexed sender, address adapter, address tokenIn, uint256 amountIn, address to
    );
    ...
    function sendMessage(address _adapter, bytes calldata _adapterData) external payable;
}
